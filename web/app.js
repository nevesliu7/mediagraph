...
function buildMetrics(meta){
  const cards = [
    ['People', meta.metrics.people, 'Creators in the graph'],
    ['Films', meta.metrics.films, 'Works in the graph'],
    ['Relationships', meta.metrics.relationships, 'Edges across the network'],
    ['Chinese creators', meta.metrics.chinese_creators, 'Chinese / Chinese-language talent'],
    ['American creators', meta.metrics.american_creators, 'U.S.-based talent'],
